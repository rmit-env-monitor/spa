...
class NewStation extends Component {
          ...
          <Row>
            <Col xs={6}>
              <select
                ...
                onChange={e => this.loadDistricts(e)}
              >
            ...
            <Col xs={6}>
              <select
                className="form-control measurement"
                onChange={e => this.loadDistrictDevices(e)}
              >
  ...
  loadDistrictDevices(e) {
    ...
    dispatch(
      actions.getDistrictDeviceList(
        citiesList[selectedCity],
        districtsList[e.target.value]
      )
    );
  }
